...
# Unit tests for ConvictionalShared::SFTPUserDeleteSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::SFTPUserDeleteSuccess do
  let(:instance) { ConvictionalShared::SFTPUserDeleteSuccess.new }

  describe 'test an instance of SFTPUserDeleteSuccess' do
    it 'should create an instance of SFTPUserDeleteSuccess' do
      expect(instance).to be_instance_of(ConvictionalShared::SFTPUserDeleteSuccess)
    end
  end
