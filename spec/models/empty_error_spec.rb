...
# Unit tests for ConvictionalShared::EmptyError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::EmptyError do
  let(:instance) { ConvictionalShared::EmptyError.new }

  describe 'test an instance of EmptyError' do
    it 'should create an instance of EmptyError' do
      expect(instance).to be_instance_of(ConvictionalShared::EmptyError)
    end
  end
