...
# Unit tests for ConvictionalShared::SFTPUserCreateSuccessData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::SFTPUserCreateSuccessData do
  let(:instance) { ConvictionalShared::SFTPUserCreateSuccessData.new }

  describe 'test an instance of SFTPUserCreateSuccessData' do
    it 'should create an instance of SFTPUserCreateSuccessData' do
      expect(instance).to be_instance_of(ConvictionalShared::SFTPUserCreateSuccessData)
    end
  end
