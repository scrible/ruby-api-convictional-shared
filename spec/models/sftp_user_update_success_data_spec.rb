...
# Unit tests for ConvictionalShared::SFTPUserUpdateSuccessData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::SFTPUserUpdateSuccessData do
  let(:instance) { ConvictionalShared::SFTPUserUpdateSuccessData.new }

  describe 'test an instance of SFTPUserUpdateSuccessData' do
    it 'should create an instance of SFTPUserUpdateSuccessData' do
      expect(instance).to be_instance_of(ConvictionalShared::SFTPUserUpdateSuccessData)
    end
  end
