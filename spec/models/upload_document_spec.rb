...
# Unit tests for ConvictionalShared::UploadDocument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::UploadDocument do
  let(:instance) { ConvictionalShared::UploadDocument.new }

  describe 'test an instance of UploadDocument' do
    it 'should create an instance of UploadDocument' do
      expect(instance).to be_instance_of(ConvictionalShared::UploadDocument)
    end
  end
  ...
  describe 'test attribute "partners_with_view_access"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
