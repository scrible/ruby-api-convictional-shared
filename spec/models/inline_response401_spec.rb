...
# Unit tests for ConvictionalShared::InlineResponse401
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::InlineResponse401 do
  let(:instance) { ConvictionalShared::InlineResponse401.new }

  describe 'test an instance of InlineResponse401' do
    it 'should create an instance of InlineResponse401' do
      expect(instance).to be_instance_of(ConvictionalShared::InlineResponse401)
    end
  end
