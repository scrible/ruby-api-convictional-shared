...
# Unit tests for ConvictionalShared::InlineResponse404
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::InlineResponse404 do
  let(:instance) { ConvictionalShared::InlineResponse404.new }

  describe 'test an instance of InlineResponse404' do
    it 'should create an instance of InlineResponse404' do
      expect(instance).to be_instance_of(ConvictionalShared::InlineResponse404)
    end
  end
