...
# Unit tests for ConvictionalShared::InlineResponse5001
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::InlineResponse5001 do
  let(:instance) { ConvictionalShared::InlineResponse5001.new }

  describe 'test an instance of InlineResponse5001' do
    it 'should create an instance of InlineResponse5001' do
      expect(instance).to be_instance_of(ConvictionalShared::InlineResponse5001)
    end
  end
