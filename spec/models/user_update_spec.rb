...
# Unit tests for ConvictionalShared::UserUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::UserUpdate do
  let(:instance) { ConvictionalShared::UserUpdate.new }

  describe 'test an instance of UserUpdate' do
    it 'should create an instance of UserUpdate' do
      expect(instance).to be_instance_of(ConvictionalShared::UserUpdate)
    end
  end
