...
# Unit tests for ConvictionalShared::InlineResponse200
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::InlineResponse200 do
  let(:instance) { ConvictionalShared::InlineResponse200.new }

  describe 'test an instance of InlineResponse200' do
    it 'should create an instance of InlineResponse200' do
      expect(instance).to be_instance_of(ConvictionalShared::InlineResponse200)
    end
  end
