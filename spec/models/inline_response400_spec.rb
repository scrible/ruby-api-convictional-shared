...
# Unit tests for ConvictionalShared::InlineResponse400
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::InlineResponse400 do
  let(:instance) { ConvictionalShared::InlineResponse400.new }

  describe 'test an instance of InlineResponse400' do
    it 'should create an instance of InlineResponse400' do
      expect(instance).to be_instance_of(ConvictionalShared::InlineResponse400)
    end
  end
