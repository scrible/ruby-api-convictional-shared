...
# Unit tests for ConvictionalShared::SFTPUserCreateSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::SFTPUserCreateSuccess do
  let(:instance) { ConvictionalShared::SFTPUserCreateSuccess.new }

  describe 'test an instance of SFTPUserCreateSuccess' do
    it 'should create an instance of SFTPUserCreateSuccess' do
      expect(instance).to be_instance_of(ConvictionalShared::SFTPUserCreateSuccess)
    end
  end
