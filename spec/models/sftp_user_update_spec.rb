...
# Unit tests for ConvictionalShared::SFTPUserUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::SFTPUserUpdate do
  let(:instance) { ConvictionalShared::SFTPUserUpdate.new }

  describe 'test an instance of SFTPUserUpdate' do
    it 'should create an instance of SFTPUserUpdate' do
      expect(instance).to be_instance_of(ConvictionalShared::SFTPUserUpdate)
    end
  end
