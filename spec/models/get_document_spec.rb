...
# Unit tests for ConvictionalShared::GetDocument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::GetDocument do
  let(:instance) { ConvictionalShared::GetDocument.new }

  describe 'test an instance of GetDocument' do
    it 'should create an instance of GetDocument' do
      expect(instance).to be_instance_of(ConvictionalShared::GetDocument)
    end
  end
