...
# Unit tests for ConvictionalShared::Company
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::Company do
  let(:instance) { ConvictionalShared::Company.new }

  describe 'test an instance of Company' do
    it 'should create an instance of Company' do
      expect(instance).to be_instance_of(ConvictionalShared::Company)
    end
  end
  ...
  describe 'test attribute "commerce_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
