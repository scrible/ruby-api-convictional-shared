...
# Unit tests for ConvictionalShared::SFTPUserCreds
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::SFTPUserCreds do
  let(:instance) { ConvictionalShared::SFTPUserCreds.new }

  describe 'test an instance of SFTPUserCreds' do
    it 'should create an instance of SFTPUserCreds' do
      expect(instance).to be_instance_of(ConvictionalShared::SFTPUserCreds)
    end
  end
