...
# Unit tests for ConvictionalShared::ErrorMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::ErrorMessage do
  let(:instance) { ConvictionalShared::ErrorMessage.new }

  describe 'test an instance of ErrorMessage' do
    it 'should create an instance of ErrorMessage' do
      expect(instance).to be_instance_of(ConvictionalShared::ErrorMessage)
    end
  end
