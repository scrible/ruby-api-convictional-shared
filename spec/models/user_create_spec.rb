...
# Unit tests for ConvictionalShared::UserCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::UserCreate do
  let(:instance) { ConvictionalShared::UserCreate.new }

  describe 'test an instance of UserCreate' do
    it 'should create an instance of UserCreate' do
      expect(instance).to be_instance_of(ConvictionalShared::UserCreate)
    end
  end
