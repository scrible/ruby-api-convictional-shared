...
# Unit tests for ConvictionalShared::OnboardingUserRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::OnboardingUserRequest do
  let(:instance) { ConvictionalShared::OnboardingUserRequest.new }

  describe 'test an instance of OnboardingUserRequest' do
    it 'should create an instance of OnboardingUserRequest' do
      expect(instance).to be_instance_of(ConvictionalShared::OnboardingUserRequest)
    end
  end
