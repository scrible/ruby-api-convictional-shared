...
# Unit tests for ConvictionalShared::InlineResponse500
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::InlineResponse500 do
  let(:instance) { ConvictionalShared::InlineResponse500.new }

  describe 'test an instance of InlineResponse500' do
    it 'should create an instance of InlineResponse500' do
      expect(instance).to be_instance_of(ConvictionalShared::InlineResponse500)
    end
  end
