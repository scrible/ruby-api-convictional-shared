...
# Unit tests for ConvictionalShared::UploadDocumentPartnersWithViewAccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::UploadDocumentPartnersWithViewAccess do
  let(:instance) { ConvictionalShared::UploadDocumentPartnersWithViewAccess.new }

  describe 'test an instance of UploadDocumentPartnersWithViewAccess' do
    it 'should create an instance of UploadDocumentPartnersWithViewAccess' do
      expect(instance).to be_instance_of(ConvictionalShared::UploadDocumentPartnersWithViewAccess)
    end
  end
