...
# Unit tests for ConvictionalShared::PartnerCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::PartnerCreate do
  let(:instance) { ConvictionalShared::PartnerCreate.new }

  describe 'test an instance of PartnerCreate' do
    it 'should create an instance of PartnerCreate' do
      expect(instance).to be_instance_of(ConvictionalShared::PartnerCreate)
    end
  end
