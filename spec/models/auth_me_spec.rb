...
# Unit tests for ConvictionalShared::AuthMe
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::AuthMe do
  let(:instance) { ConvictionalShared::AuthMe.new }

  describe 'test an instance of AuthMe' do
    it 'should create an instance of AuthMe' do
      expect(instance).to be_instance_of(ConvictionalShared::AuthMe)
    end
  end
