...
# Unit tests for ConvictionalShared::User
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::User do
  let(:instance) { ConvictionalShared::User.new }

  describe 'test an instance of User' do
    it 'should create an instance of User' do
      expect(instance).to be_instance_of(ConvictionalShared::User)
    end
  end
