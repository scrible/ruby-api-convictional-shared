...
# Unit tests for ConvictionalShared::OnboardingState
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConvictionalShared::OnboardingState do
  let(:instance) { ConvictionalShared::OnboardingState.new }

  describe 'test an instance of OnboardingState' do
    it 'should create an instance of OnboardingState' do
      expect(instance).to be_instance_of(ConvictionalShared::OnboardingState)
    end
  end
